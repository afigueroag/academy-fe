...
const STATUS_FILTERS: { value: StatusFilter; label: string }[] = [
  ...
  { value: 'all', label: 'Todas menos anuladas' },
...
export default function Sales() {
  ...
  const handleEdit = async (id: number, payload: TransactionUpdate) => {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        ...
        setPanelError('No se pudo actualizar la transacción.');
      }
    } finally {
      setSubmitting(false);
    }
  ...
  const confirmDeactivate = async () => {
    ...
    try {
      ...
      showToast('Cobro recurrente desactivado');
  ...
  const moduleTabs = (
    <div className="module-tabs">
      <div className="tab-group" role="tablist" aria-label="Pestañas de ventas">
        <button
          type="button"
          role="tab"
  ...
  return (
    <Layout title="Ventas" actions={headerActions}>
      {moduleTabs}
          ...
          <section className="summary-grid">
            {isReceptionist ? (
              <div className="summary-card">
                <p className="summary-card__label">Transacciones pendientes</p>
              ...
              <>
                <div className="summary-card">
                  {/* `total` suma también lo `scheduled` (cargos futuros ya
                      generados, hasta dos meses): decir "Ingresos totales" a
                      secas se lee como dinero que entró y no lo es. */}
                  <p className="summary-card__label">
                    Facturado (incl. programado)
                  </p>
                  <div className="summary-card__value">
                ...
                <div className="summary-card">
                  <p className="summary-card__label"># Transacciones</p>
                  <div className="summary-card__value">
                    {summary === null ? '—' : summary.total_count}
                  </div>
                </div>
                <div className="summary-card">
                  <p className="summary-card__label">Cobrado</p>
                  <div className="summary-card__value">
                    {summary === null ? '—' : formatMoney(summary.paid, currency)}
                  </div>
                </div>
                <div className="summary-card">
                  <p className="summary-card__label">Por cobrar</p>
                  <div className="summary-card__value">
                    {summary === null
                      ? '—'
            ...
            <div className="table-wrapper">
                {loading ? (
                  <div className="loading-row">
                    <SpinnerIcon size={16} /> Cargando transacciones…
                  </div>
                  ...
                  <div className="empty-state">
                    ...
                    <p>Ajusta los filtros o crea una nueva.</p>
                  </div>
                ) : (
        ...
        <>
          {!isReceptionist && (
            <section className="summary-grid">
              ...
              <div className="summary-card">
                <p className="summary-card__label">Monto mensual proyectado</p>
                <div className="summary-card__value">
            ...
            <div className="filter-bar">
              <div className="search-input">
                ...
                <input
                  ...
                  placeholder="Buscar por descripción o cliente"
                  aria-label="Buscar cobros recurrentes"
                />
              </div>
              <select
                className="select"
          ...
          <section>
            ...
            <div className="table-wrapper">
              {recurringLoading ? (
                <div className="loading-row">
                  <SpinnerIcon size={16} /> Cargando cobros recurrentes…
                </div>
              ) : recurringList.length === 0 ? (
                <div className="empty-state">
                  <p className="empty-state__title">
                    Sin cobros recurrentes que coincidan
                  </p>
                ...
                <table className="users-table">
                  <thead>
                    <tr>
                      ...
                      <th>Categoría</th>
                      <th>Frecuencia</th>
                      <th className="table-cell--nowrap">Día de cobro</th>
                      <th
                        className="table-cell--nowrap"
                        style={{ textAlign: 'right' }}
                      >
      ...
      >
        {panel?.kind === 'view' && (
          <TransactionDetails transaction={panel.tx} currency={currency} />
        )}
      </SidePanel>
      ...
      <ConfirmModal
        ...
        message="Al desactivar, también se cancelarán todos los cobros futuros aún no vencidos. Las deudas vencidas y los pagos ya realizados no se tocan."
